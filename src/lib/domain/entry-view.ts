...
export interface EntryView {
  ...
  path: string | null;
  /**
   * The project's public-site document, when one is configured. It is the owned, validated
   * website destination — the one the overview links to and `ongoing export` publishes — as
   * opposed to any `url`-typed field someone happens to register.
   */
