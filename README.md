...
![The inventory in a light theme](docs/qa/screens/inventory-light.png)
![The technology radar](docs/qa/screens/radar-dark.png)
...
```sh
git clone https://github.com/marcus/ongoing.git ongoing && cd ongoing
...
```sh
ongoing init --scan-root ~/code       # a commented config.toml, a data directory, a catalog
